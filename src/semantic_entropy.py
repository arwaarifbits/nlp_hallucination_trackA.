...
def compute_semantic_entropy(self, query: str, context: str,
    ...
    # Generate completions using the existing helper
    completions = self._sample_completions(prompt, num_samples=num_samples)
    ...
    # Use NLI clustering (proper semantic entropy, not string matching)
